...
export const DEFAULT_GREENHOUSE_BOARDS: readonly string[] = [
  ...
  'applovin', 'asana', 'astranis', 'attentive', 'axios', 'bitgo', 'bitwarden', 'braze',
  'brex', 'buzzfeed', 'calendly', 'calm', 'cameo', 'carta', 'chime', 'classpass',
  'cloudflare', 'cockroachlabs', 'coinbase', 'consensys', 'contentful', 'coursera', 'customerio', 'dashlane',
  'databricks', 'datadog', 'discord', 'doximity', 'dremio', 'dropbox', 'duolingo', 'elastic',
  'epicgames', 'faire', 'fastly', 'figma', 'figure', 'fireblocks', 'fivetran', 'flexport',
  'gemini', 'gitlab', 'glossier', 'gocardless', 'greenhouse', 'gusto', 'hightouch', 'honeycomb',
  'hootsuite', 'instacart', 'intercom', 'iterable', 'justworks', 'kayak', 'klaviyo', 'labelbox',
  'lastpass', 'lattice', 'launchdarkly', 'lucidmotors', 'lyft', 'masterclass', 'mercury', 'mindbody',
  'mixpanel', 'mongodb', 'monzo', 'n26', 'nansen', 'netlify', 'netskope', 'newrelic',
  'nextdoor', 'nuro', 'okta', 'opentable', 'oscar', 'oura', 'pagerduty', 'peloton',
  'pendo', 'pinterest', 'planetscale', 'postman', 'reddit', 'riotgames', 'robinhood', 'roblox',
  'rocketlab', 'salesloft', 'samsara', 'scaleai', 'scopely', 'sendbird', 'sigmacomputing', 'singlestore',
  'sofi', 'sproutsocial', 'squarespace', 'starburst', 'stockx', 'stripe', 'sumologic', 'tanium',
  'toast', 'tripadvisor', 'truelayer', 'turing', 'twilio', 'twitch', 'udemy', 'upstart',
  'upwork', 'vercel', 'waymo', 'webflow', 'ziprecruiter', 'zscaler',
];
